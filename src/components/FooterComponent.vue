<template>
    <footer class="bg-white">
      <div class="mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8">
        ...
        <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; 2023 KicksKarma, All rights reserved.</p>
      </div>
    </footer>
  </template>
  ...
  const navigation = {
    ...
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/people/KicksKarma-Store/100092677224766/',
      ...
      {
        name: 'Instagram',
        href: 'https://instagram.com/kicks.karma',
        icon: defineComponent({
          render: () =>
            h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
              h('path', {
